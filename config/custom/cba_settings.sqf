...
force force ace_hearing_explosionDeafnessCoefficient = 0.5;
...
force force ace_nightvision_noiseScaling = 0.768337;
...
force force DBUG_alwaysShowConsole = true;
force force DBUG_replaceDebugConsole = true;
...
force force TFAR_setting_defaultFrequencies_lr_west = "84.1,80,30,40,50,38.1,36.8,39";
force force TFAR_setting_defaultFrequencies_sr_east = "";
force force TFAR_setting_defaultFrequencies_sr_independent = "";
force force TFAR_setting_defaultFrequencies_sr_west = "31.1,31.2,31.3,31.4,32.1,32.2,32.3,31";
...
force force TFAR_Teamspeak_Channel_Name = "TaskForceRadio_Main";
force force TFAR_Teamspeak_Channel_Password = "rwezui";
force force tfar_terrain_interception_coefficient = 10;
...
force force Vcm_AISkills_General_AimingAccuracy = 0.9;
...
force force Vcm_AISkills_General_spotDistance = 0.6;
...
force force VCM_CARGOCHNG = false;
...
force force zen_editor_unitRadioMessages = 1;
